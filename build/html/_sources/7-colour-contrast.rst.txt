...
.. image:: Images/contrast-example.png
   :alt: A web interface with a high contrast 'Accept' button and poor contrast 'Ignore' button
   :width: 15cm
   :align: center
...
How is colour contrast different from colour blindness?
TODO Counterexample where different hues but same contrast.
[I have an example in Figma]
